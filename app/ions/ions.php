...
class Ions
{
	...
	public function make(array $args)
	{
		...
		if($action == 'make:plugin')
		{
			...
			$plugin_file_source = 'app/ions/samples/plugin-sample.php';
			...
			$controller_file_source = 'app/ions/samples/controller-sample.php';
			...
			$view_file_source = 'app/ions/samples/view-sample.php';
			...
			$js_file_source = 'app/ions/samples/js-sample.js';
			...
			$css_file_source = 'app/ions/samples/css-sample.css';
			...
			$config_file_source = 'app/ions/samples/config-sample.json';
		...
		if($action == 'make:migration')
		{
			...
			$file_sample = 'app/ions/samples/migration-sample.php';
		...
		if($action == 'make:model')
		{
			...
			$file_sample = 'app/ions/samples/model-sample.php';
			if(!file_exists($file_sample))
	...
	public function migrate(array $args)
	{
		...
		if($action == 'migrate:refresh')
		{
			...
			$this->migrate(['ions','migrate:rollback',$folder,$file_name]);
			$this->migrate(['ions','migrate',$folder,$file_name]);
	...
	IonsPHP v$version Command Line Tool
